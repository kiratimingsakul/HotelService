...
package com.example.administrator.hotelservice.service;
...
//    send to put title
    private void sendNotification(String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), ShowDetail.class);
        notificationIntent.putExtra("Event",notificationDetails);
        ...
        builder.setSmallIcon(R.mipmap.ic_launcher)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(getResources(),
                        R.drawable.mark))
                .setColor(Color.RED)
                .setContentTitle("ภายในระยะทางไม่เกิน 1 กิโลเมตร:")
                .setSound(soundUri)
